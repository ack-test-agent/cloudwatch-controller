...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	r.ko.Spec.RuleName = &identifier.NameOrID
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	primaryKey, ok := fields["ruleName"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: ruleName"))
	}
	r.ko.Spec.RuleName = &primaryKey
