...
func (rm *resourceManager) sdkFind(
	...
	for _, elem := range resp.InsightRules {
		...
		if elem.Definition != nil {
			ko.Spec.Definition = elem.Definition
		} else {
...
func (rm *resourceManager) newCreateRequestPayload(
	...
	if r.ko.Spec.Definition != nil {
		res.RuleDefinition = r.ko.Spec.Definition
	}
	if r.ko.Spec.Name != nil {
		res.RuleName = r.ko.Spec.Name
	}
	if r.ko.Spec.State != nil {
		res.RuleState = r.ko.Spec.State
	}
...
func (rm *resourceManager) sdkDelete(
	...
	input.RuleNames = []string{*r.ko.Spec.Name}
